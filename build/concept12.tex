...
但若 $\Delta R_C \neq 0$，兩臂輸出變動量不等，差動輸出不為零：
\[
  |\Delta V_o| = \frac{|\Delta V_{cm}|\cdot\Delta R_C}{2R_A}
\]

\begin{formulabox}
\textbf{共模增益：}
\[
  A_{cm} = \frac{\Delta R_C}{2R_A} \tag{12.21}
\]
...
\[
  I_o = \frac{I_{ref}}{1 + \dfrac{2}{\beta(\beta+2)}} \tag{12.33}
\]
與基本鏡比較：分母中的 $2/\beta$ 被改善為 $2/[\beta(\beta+2)]$，對 $\beta = 100$ 而言，
...
\begin{enumerate}[leftmargin=2em,itemsep=3pt]
  ...
  \item \textbf{電流鏡}提供穩定的電流源：
        \begin{itemize}[leftmargin=1.5em,itemsep=1pt]
          ...
          \item Wilson 鏡——誤差降至 $2/[\beta(\beta+2)]$、$R_o = \beta r_o/2$。
...
Wilson 鏡 $I_o$ & $\dfrac{I_{ref}}{1+2/[\beta(\beta+2)]}$ & (12.33) \\[4pt]
