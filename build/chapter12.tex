...
\begin{itemize}[leftmargin=2.0em,itemsep=2pt]
  ...
  \item \textbf{Wilson 鏡（圖 P12.3）}：$I_{ref}=\dfrac{V_{CC}-1.4}{R_{ref}}$，
        $I_o=\dfrac{I_{ref}}{1+2/[\beta(\beta+2)]}$ (12.33)，$R_o=\dfrac{\beta}{2}r_o$ (12.37)——基極電流誤差極小、輸出電阻極高。
...
\sol 先求單端增益：$G_m=\dfrac{2\text{m}}{4(25\text{m})}=0.02$ S，單端 $A_{d1}=-G_mR_C=-0.02(5\text{k})=-100$，$A_{d2}=+100$。\\
DC 偏壓：$V_{o(DC)}=V_{CC}-(I_A/2)R_C=10-1\text{m}\times5\text{k}=5$ V。輸出 $V_{oi}=V_{o(DC)}+A_{di}V_d$，$V_d=V_1-V_2$。\\
\textbf{(1)} $V_d=10\text{mV}\sin\omega_1t$：
\[ V_{o1}=5-1\,\sin\omega_1t\ \text{(V)},\qquad V_{o2}=5+1\,\sin\omega_1t\ \text{(V)}. \]
\textbf{(2)} $V_d=10\text{mV}\sin\omega_1t-5\text{mV}\sin\omega_2t$：
\[ V_{o1}=5-1\sin\omega_1t+0.5\sin\omega_2t\ \text{(V)},\quad
   V_{o2}=5+1\sin\omega_1t-0.5\sin\omega_2t\ \text{(V)}. \]
\ans{DC 偏壓 5 V，再疊加單端差動增益 $\mp100$ 乘 $V_d$。}
...
\[ I_{ref}=\frac{V_{CC}-1.4}{R_{ref}}=\frac{10.6}{10\text{k}}=1.06\ \text{mA},\quad
   I_o=\frac{I_{ref}}{1+\frac{2}{\beta(\beta+2)}}\approx1.06\ \text{mA}\ (\text{誤差}\approx0.02\%). \]
