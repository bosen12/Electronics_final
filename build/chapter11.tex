...
須考慮 $R_1$ 使 $Q_3$ 射極電位上升。設 $V_{E3}$ 為 $Q_3$ 射極電壓，由 $R_3$、$R_2$、$R_1$ 聯立：
\[
V_{B4}=V_{E3}+1.4,\quad I_{R_3}=\frac{5-V_{E3}-1.4}{4\text{k}},\quad
I_{R_2}=\frac{5-V_{E3}-0.2}{1.6\text{k}},\quad I_{E3}=\frac{V_{E3}}{1\text{k}}
\]
由 $I_{E3}=I_{R_2}+I_{R_3}$ 解得
\[ V_{E3}=2.08\ \text{V},\quad I_{R_3}\approx0.38\ \text{mA},\quad I_{R_2}\approx1.70\ \text{mA}. \]
\[ I_H=I_{R_3}+I_{R_2}=2.08\ \text{mA},\quad P_H=V_{CC}I_H=5\times2.08=10.4\ \text{mW}. \]
\[ P=\tfrac12(P_L+P_H)\approx\tfrac12(5.13+10.4)\approx7.8\ \text{mW}. \]
\ans{$P_{avg}\approx7.8$ mW。}
